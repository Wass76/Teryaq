...
public class EmployeeEmailGenerationTest {
    ...
    public void testEmailFormat() {
        // Test expected email format: firstname.lastname.pharmacy.license@teryaq.com
        String expectedFormat = "ahmad.muhammad.pharmacy123.abc@teryaq.com";
        
        assertTrue(expectedFormat.contains("@teryaq.com"), "Email should use @teryaq.com domain");
        assertTrue(expectedFormat.matches("^[a-z0-9.]+@teryaq\\.com$"), "Email should follow proper format");
    }
    ...
    public void testEmailUniqueness() {
        ...
        String baseEmail = "test.employee.pharmacy123.abc@teryaq.com";
        String uniqueEmail1 = "test.employee.pharmacy123.abc1@teryaq.com";
        String uniqueEmail2 = "test.employee.pharmacy123.abc2@teryaq.com";
