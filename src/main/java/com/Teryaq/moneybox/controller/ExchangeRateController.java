...
public class ExchangeRateController {
    ...
    public ResponseEntity<ExchangeRateResponseDTO> getCurrentRate(
            @Parameter(description = "Source currency", example = "USD") @PathVariable String fromCurrency,
            @Parameter(description = "Target currency", example = "SYP") @PathVariable String toCurrency) {
    ...
    public ResponseEntity<CurrencyConversionResponseDTO> convertAmount(
            ...
            @Parameter(description = "Source currency", example = "USD") @RequestParam String fromCurrency,
            @Parameter(description = "Target currency", example = "SYP") @RequestParam String toCurrency) {
    ...
    @PostMapping
    @Operation(summary = "Set exchange rate", description = "Set a new exchange rate for a currency pair")
    @ApiResponses(value = {
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Deactivate exchange rate", description = "Deactivate an exchange rate (soft delete)")
    @ApiResponses(value = {
