package com.Teryaq.complaint.mapper;
...
public class ComplaintMapper {
    ...
    public void updateEntity(Complaint complaint, ComplaintUpdateRequestDTO dto, Long updatedBy) {
        ...
        if (dto.getStatus() == com.Teryaq.complaint.enums.ComplaintStatus.RESOLVED || 
            dto.getStatus() == com.Teryaq.complaint.enums.ComplaintStatus.CLOSED) {
