package com.Teryaq.reports.mapper;
...
public class ReportMapper {
     ...
     */
    private com.Teryaq.product.Enum.ProductType convertToProductType(Object value) {
        if (value == null) {
            return null;
        }
        if (value instanceof com.Teryaq.product.Enum.ProductType) {
            return (com.Teryaq.product.Enum.ProductType) value;
        }
        if (value instanceof String) {
            try {
                return com.Teryaq.product.Enum.ProductType.valueOf((String) value);
